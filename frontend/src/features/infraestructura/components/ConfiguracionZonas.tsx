...
import { Layers, Plus, Loader2, Grid2X2, MapPin } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-slate-900/60 p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6">
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="Ej: Marina Norte, Complejo Delta"
          ...
          <button 
            ...
            className="w-full bg-green-600 hover:bg-green-500 disabled:opacity-50 text-white font-bold py-4 rounded-2xl shadow-xl shadow-green-600/20 transition-all active:scale-95 flex justify-center gap-2 items-center"
          >
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-900/60 p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Seleccionar Ubicación</label>
            <select 
